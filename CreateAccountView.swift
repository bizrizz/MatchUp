...
struct CreateAccountView: View {
    ...
    private func createAccount() {
        ...
        let userId = Int.random(in: 100000...999999) // Generate a random userId
        networkManager.createAccount(userName: username, userNickName: username, email: email, userId: userId, password: password) { success, error in

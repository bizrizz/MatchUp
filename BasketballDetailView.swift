...
struct SchoolDetailView_Previews: PreviewProvider {
    static var previews: some View {
        let sampleSchool = School(name: "Dr Norman Bethune Collegiate Institute", coordinate: CLLocationCoordinate2D(latitude: 43.8016, longitude: -79.3181))
        SchoolDetailView(
            school: sampleSchool,
            activePlayers: 5,
